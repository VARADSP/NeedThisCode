						...
						<td>
							...
							<s:iterator value="listbean.arrList" status="itstatus"
								...
								<s:if test="#status == 'web' && #bool_b1 == 'true'">
									<input type="checkbox" name="listbean.areaofinterest" id="interest" value="web"
										<s:if test= "#status == 'web'">checked</s:if>> Web Programming <br>
									<s:set var="bool_b1" value="false" />
								</s:if>
								<s:if test="#status == 'database' && #bool_b2 == 'true'">
									<input type="checkbox" name="listbean.areaofinterest" id="interest" value="database"
								...
								<s:if test="#status == 'swing' && #bool_b3 == 'true'">
									<input type="checkbox" name="listbean.areaofinterest" id="interest" value="swing"
								...
								<s:if test="#status == 'mobile' && #bool_b4 == 'true'">
									<input type="checkbox" name="listbean.areaofinterest" id="interest" value="mobile"
								...
								test="#bool_b1 == 'true'">
								<input type="checkbox" name="listbean.areaofinterest" id="interest" value="web"> Web Programming <br>
							</s:if> <s:if test="#bool_b2 == 'true'">
								<input type="checkbox" name="listbean.areaofinterest" id="interest" value="database"> Database Programming <br>
							</s:if> <s:if test="#bool_b3 == 'true'">
								<input type="checkbox" name="listbean.areaofinterest" id="interest" value="swing"> Swing Programming <br>
							</s:if> <s:if test="#bool_b4 == 'true'">
								<input type="checkbox" name="listbean.areaofinterest" id="interest" value="mobile"> Mobile Programming <br>
							</s:if>
						</td>
					</tr>
