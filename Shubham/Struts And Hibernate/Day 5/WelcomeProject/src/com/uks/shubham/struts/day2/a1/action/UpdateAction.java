...
public class UpdateAction extends ActionSupport{
	...
	public String execute() throws SQLException, IOException{
		//calling method updateuser with parameter as object and return message
		...
		if(message == Constants.updateRecordSucc){
			...
			addActionError(Constants.updateRecordSucc);
			return SUCCESS;
		}
		else{
			//if records not updated then return error and error print message
