	...
	<div class="well user">
		...
		<s:form action="userInfoOnly" method="post" namespace="/">
			...
			<table class="userdet table">
				...
				<tr>
					<td>Date Of Birth: <s:property value="objuser.birth" /></td>
				</tr>
				<tr>
					<td>Address: <s:property value="objuser.Address" /></td>
				</tr>
				<tr>
					<td>User Name: <s:property value="objuser.uname" /></td>
				</tr>
				<tr>
					<td>Password: <s:property value="objuser.pass" /></td>
				</tr>
				<tr>
					<td>Interest: <s:property value="objuser.interest" /></td>
				</tr>
				<tr>
					<td>Other Interest: <s:property value="objuser.othintrest" /></td>
				</tr>
				<tr>
		...
		<a
			href="Struts2/editaction.action?uname=<s:property value="objuser.uname"/>"
